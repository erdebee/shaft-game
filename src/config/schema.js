...
export const TUNABLES = {
  ...
  'power.defaultJunctionPriority': N(1, 5),

  'infrastructure.enforced': LIST,
  ...
  'air.oxygenPerCapitaPerTick': N(0, 10),
  'air.sewageLoadPerUnit': N(0, 10),
  ...
  'population.workersPerStaffPoint': N(1, 1000),
  'population.healthStart': METER,
  'population.healthBaseline': METER,
  'population.healthDriftPerTick': N(0, 100),
  'population.hungerHealthPenalty': METER,
  'population.thirstHealthPenalty': METER,
  'population.badWaterHealthPenalty': METER,
  'population.badAirHealthPenalty': METER,
  'population.waterQualitySafe': METER,
  'population.illnessThreshold': METER,
  'population.sickShareAtZeroHealth': RATE,
  'population.starvationDeathRate': RATE,
  'population.thirstDeathRate': RATE,
  'population.suffocationDeathRate': RATE,
  'population.illnessDeathRate': RATE,
  ...
  'factions.satisfactionApproachPerTick': N(0, 100),
  'factions.satisfactionFloor': METER,
  'factions.satisfactionRange': METER,
  'factions.discontentWeight': N(0, 10),

  'unrest.warnThreshold': METER,
  'unrest.strikeThreshold': METER,
  'unrest.demandsThreshold': METER,
  'unrest.riotThreshold': METER,
  'unrest.departureThreshold': METER,
  'unrest.strikeDurationTicks': TICKS,
  'unrest.strikeCooldownTicks': TICKS,
  'unrest.demandsCooldownTicks': TICKS,
  'unrest.riotTargetsPerShift': N(0, 100),
  'unrest.riotDamage': RATE,
  'unrest.departureRatePerTick': RATE,
  ...
  'governance.sessionTicks': TICKS,
  'governance.leaningVisibleAtCount': N(1, 20),
  ...
  'governance.flipFlopMeters': LIST,
  ...
  'narrative.promiseHoldTicks': TICKS,
  'narrative.promiseKeptSoftBonus': RATE,
  'narrative.promiseBrokenSoftMalus': RATE,
...
export const EFFECT_OPS = {
  ...
  'meter.shift': { targets: 'meters', value: 'number' },
...
export const PREDICATES = {
  ...
  'need.below': { targets: null, value: 'number' },
  'need.atLeast': { targets: null, value: 'number' },
